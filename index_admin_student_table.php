...
$sql = "SELECT * FROM student WHERE id_num LIKE '%$search%' OR firstname LIKE '%$search%' OR middlename LIKE '%$search%' OR lastname LIKE '%$search%' 
OR course LIKE '%$search%' OR yearlevel LIKE '%$search%' OR gender LIKE '%$search%' OR date_registered LIKE '%$search%' LIMIT $start, $resultsPerPage";
$result = $con->query($sql);

// Retrieve total number of admin records for pagination calculation
$totalRecords = $con->query("SELECT COUNT(*) as count FROM student WHERE id_num LIKE '%$search%' OR firstname LIKE '%$search%' OR middlename LIKE '%$search%' OR lastname LIKE '%$search%'
OR course LIKE '%$search%' OR yearlevel LIKE '%$search%' OR gender LIKE '%$search%' OR date_registered LIKE '%$search%'")->fetch_assoc()['count'];
