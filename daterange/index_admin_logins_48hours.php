...
$sql_logins = "SELECT id_num,timestamp,COUNT(*) AS login_count FROM logins WHERE DATE(timestamp) >= DATE_SUB(CURDATE(), INTERVAL 2 DAY) GROUP BY id_num
;";
...
$sql_logins2 = "SELECT ip_address,timestamp,COUNT(*) AS login_count2 FROM logins WHERE DATE(timestamp) >= DATE_SUB(CURDATE(), INTERVAL 2 DAY) GROUP BY ip_address
;";
...
logins WHERE DATE(timestamp) >= DATE_SUB(CURDATE(), INTERVAL 2 DAY) GROUP BY full_name, login_date;";
        ...
        <div class="search-bar" style="display:flex; justify-content:center; gap:10px;">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="../index_admin_logins.php" id="twentyeight_days" onclick="selectdate('seven')">Last 24 hours</a></li>
                    <li><a class="dropdown-item" href="daterange/index_admin_registrants_28days.php" id="twentyeight_days" onclick="selectdate('twenty_eight')">Last 3 days</a></li>
                    <li><a class="dropdown-item" href="daterange/index_admin_registrants_month.php" id="month" onclick="selectdate('month')">Last 5 days</a></li>
