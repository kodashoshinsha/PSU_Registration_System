...
$sql = "SELECT yearlevel, COUNT(*) AS count, MONTH(date_registered) AS month
...
$sql2 = "SELECT course,COUNT(*) as course_count FROM student WHERE date_registered >= DATE_SUB(CURDATE(), INTERVAL 28 DAY) GROUP BY course";
...
$sql3 = "SELECT gender,COUNT(*) as gender_count FROM student WHERE date_registered >= DATE_SUB(CURDATE(), INTERVAL 28 DAY) GROUP BY gender";
        ...
        <div class="search-bar" style="display:flex; justify-content:center; gap:10px;">
            ...
            <button class="btn btn-light dropdown-toggle" style="padding-bottom: 6%;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="../index_admin_registrants2.php" >Admin</a></li>
                </ul>
                <button class="btn btn-light dropdown-toggle" style="padding-bottom: 6%;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    Current Month
                </button>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="../index_admin_registrants.php" id="twentyeight_days" onclick="selectdate('seven')">Last 7 days</a></li>
                    <li><a class="dropdown-item" href="index_admin_registrants_28days.php" id="twentyeight_days" onclick="selectdate('twenty_eight')">Last 28 days</a></li>
                    <li><a class="dropdown-item" href="#" id="month" onclick="selectdate('month')">Current month</a></li>
        ...
        <!-- YEAR CHART -->
           <div class="chart2">
                <div class="chart-header">
                    <span style="padding-left:1%;font-size:large;color:white;">Year level</span>
    ...
    window.onload = function() {
        ...
        chart_courseBar = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Number of Registrant (Course)',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('twentyeight_days').addEventListener('click', function(e) {
        e.preventDefault(); // Prevent the default link behavior
        displayChart(); // Call the displayChart function
    });
});
