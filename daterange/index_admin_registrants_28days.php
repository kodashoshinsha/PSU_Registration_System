...
$sql = "SELECT yearlevel,COUNT(*) as count FROM student WHERE date_registered >= DATE_SUB(CURDATE(), INTERVAL 28 DAY) GROUP BY yearlevel";
    ...
    <div class="content" >
        ...
        <div class="search-bar" style="display:flex; justify-content:center; gap:10px;">
            ...
            <button class="btn btn-light dropdown-toggle" style="padding-bottom: 6%;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="../index_admin_registrants.php" id="seven_days" onclick="selectdate('seven')">Last 7 days</a></li>
                    <li><a class="dropdown-item" href="#" id="twentyeight_days" onclick="selectdate('twenty_eight')">Last 28 days</a></li>
                    <li><a class="dropdown-item" href="index_admin_registrants_month.php" id="month" onclick="selectdate('month')">Current month</a></li>
