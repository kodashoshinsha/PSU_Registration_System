...
$sql = "SELECT college,COUNT(*) as count FROM admin WHERE date_registered >= DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY college";
$result = mysqli_query($con, $sql);
$data = array();
while ($row = mysqli_fetch_array($result)) {
  $data[$row['college']] = $row['count'];
  }
$labels = array_keys($data);
$values = array_values($data);

$sql2 = "SELECT gender,COUNT(*) as gender_count FROM admin WHERE date_registered >= DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY gender";
$result2 = mysqli_query($con, $sql2);
$data2 = array();
while ($row = mysqli_fetch_array($result2)) {
  $data2[$row['gender']] = $row['gender_count'];
  }
        ...
        <div class="search-bar" style="display:flex; justify-content:center; gap:10px;">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="index_admin_registrants.php">Student</a></li>
                </ul>
                <button class="btn btn-light dropdown-toggle" style="padding-bottom: 6%;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    Last 7 days
                </button>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="#" id="twentyeight_days" onclick="selectdate('seven')">Last 7 days</a></li>
                    <li><a class="dropdown-item" href="daterange/index_admin_registrants_28days.php" id="twentyeight_days" onclick="selectdate('twenty_eight')">Last 28 days</a></li>
                    <li><a class="dropdown-item" href="daterange/index_admin_registrants_month.php" id="month" onclick="selectdate('month')">Current month</a></li>
        ...
        <!-- YEAR CHART -->
           <div class="chart2">
                <div class="chart-header">
                    <span style="padding-left:1%;font-size:large;color:white;">Department</span>
                    <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements('bar')" style="color:white;margin-left:70.5%">Bar Chart</button>
    ...
    window.onload = function() {
        ...
        chart_Today = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Number of Registrant (Department)',
...
<div class="chart2">
    <div class="chart-header2">
        <span style="padding-left:1%;font-size:large;color:white;">Course</span>
        <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements2('bar')" style="color:white;margin-left:72%">Bar Chart</button>
...
<!-- <div class="chart2">
    <div class="chart-header3">
        ...
        <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements3('bar')" style="color:white;margin-left:68%">Bar Chart</button>
        ...
        <a href=""><i class="fa-solid fa-circle-down fa-xl" style="color: #ffffff; margin-left:3.5%;"></i></a>
    </div>
    <div id="genderBar">
