...
$sql = "SELECT yearlevel, COUNT(*) AS count FROM student WHERE course = 'Bachelor of Science in Civil Engineering' GROUP BY yearlevel;";
...
$sql2 = "SELECT yearlevel, COUNT(*) AS count FROM student WHERE course = 'Bachelor of Science in Computer Engineering' GROUP BY yearlevel";
...
$sql3 = "SELECT yearlevel, COUNT(*) AS count FROM student WHERE course = 'Bachelor of Science in Architecture' GROUP BY yearlevel";
$result3 = mysqli_query($con, $sql3);
$data3 = array();
while ($row = mysqli_fetch_array($result3)) {
  $data3[$row['yearlevel']] = $row['count'];
  }
        ...
        <div class="search-bar" style="display:flex; justify-content:center; gap:10px;">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" href="#" id="twentyeight_days">College of Engineering and Architecture</a></li>
                    <li><a class="dropdown-item" href="index_admin_enrollees_EDUC.php" id="month">College of Arts and Education</a></li>
                </ul>
            </div>
	    </div>
        <br>
        <!-- BSCE CHART -->
           <div class="chart2">
                <div class="chart-header5">
                    <span style="padding-left:1%;font-size:large;color:white;">Bachelor of Science in Civil Engineering</span>
                    <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements('bar')" style="color:white;margin-left:50%">Bar Chart</button>
...
<div class="chart2">
    <div class="chart-header5">
        <span style="padding-left:1%;font-size:large;color:white;">Bachelor of Science in Computer Engineering</span>
        <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements2('bar')" style="color:white;margin-left:45%">Bar Chart</button>
...
<div class="chart2">
    <div class="chart-header3">
        <span style="padding-left:1%;font-size:large;color:white;">Bachelor of Science in Architecture</span>
        <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements3('bar')" style="color:white;margin-left:52.5%">Bar Chart</button>
