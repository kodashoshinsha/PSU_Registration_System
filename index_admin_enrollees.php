...
$sql = "SELECT yearlevel, COUNT(*) AS count FROM student WHERE course = 'Bachelor of Science in Information Technology' GROUP BY yearlevel;";
...
$sql2 = "SELECT yearlevel, COUNT(*) AS count FROM student WHERE course = 'Bachelor of Science in Mathematics' GROUP BY yearlevel";
        ...
        <div class="search-bar" style="display:flex; justify-content:center; gap:10px;">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="#" id="twentyeight_days">College of Computing</a></li>
                    <li><a class="dropdown-item" href="college/index_admin_enrollees_ENG.php" id="twentyeight_days">College of Engineering and Architecture</a></li>
                    <li><a class="dropdown-item" href="daterange/index_admin_registrants_month.php" id="month">College of Arts and Education</a></li>
                </ul>
            </div>
	    </div>
        <br>
        <!-- BSIT CHART -->
           <div class="chart2">
                <div class="chart-header5">
                    <span style="padding-left:1%;font-size:large;color:white;">Bachelor of Science in Information Technology</span>
                    <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements('bar')" style="color:white;margin-left:45%">Bar Chart</button>
...
<div class="chart2">
    <div class="chart-header5">
        <span style="padding-left:1%;font-size:large;color:white;">Bachelor of Science in Mathematics</span>
        <button type="button" class="btn btn-primary" id="btnbar" onclick="toggleElements2('bar')" style="color:white;margin-left:53%">Bar Chart</button>
