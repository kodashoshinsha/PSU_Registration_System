...
$sql = "SELECT yearlevel,COUNT(*) as count FROM student WHERE date_registered >= DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY yearlevel";
...
$sql2 = "SELECT course,COUNT(*) as course_count FROM student WHERE date_registered >= DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY course";
    ...
    window.onload = function() {
        ...
        chart_Today = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label:'Number of Registrants (Year level)',
